...
const projects = [
  { type: 'video', src: {video1}, desc: 'A fun Flappy Bird clone built with HTML, CSS, and JavaScript where players control a bird and navigate through moving pipes. The game features smooth animations, scoring, and game-over mechanics for an engaging experience.', reverse: false },
  { type: 'video', src: {video2}, desc: 'A simple calculator built with HTML, CSS, and JavaScript that performs basic arithmetic operations. It provides a clean interface with responsive design for quick and easy calculations.', reverse: true },
